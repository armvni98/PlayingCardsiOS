...
@IBDesignable class PlayingCardView: UIView {
    ...
    func turnFaceDown(animated: Bool = true) {
...
//    func turnFaceDownPause(delay: TimeInterval, duration: TimeInterval) {
//
////        UIView.animate(
////                          withDuration: 0.5,
////                          delay: 0.5,
...
//    }
//
//    func turnFaceUpPause(animated: Bool = true) {
//
//        UIView.transition(with:     self,
//                          duration: 2,
//                          options:  .transitionFlipFromLeft,
...
//    }
    ...
    @IBInspectable var rank: Int = 12.arc4random + 1 {
        didSet {
            setNeedsDisplay()
            setNeedsLayout()
    ...
    @IBInspectable var suit: String = PlayingCard.Suit.all.randomElement()!.description  {
        didSet {
            setNeedsDisplay()
            setNeedsLayout()
        }
